          ...
          @foreach($allData as $data)
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                <a href="/commissionlist/{{$data->commission_type_id}}/commission/{{$data->commission_id}}"><img class="card-img-top" src="{{url('uploads/commission/'.$data->commission_image)}}" width="200px" height="200px" alt=""></a>
                <div class="card-body">
                  <h4 class="card-title">
